...
worksIntro1 = [
     ...
     ImageSendMessage(original_content_url='https://scontent.ftpe2-2.fna.fbcdn.net/v/t31.0-8/30420598_1772746002786979_2578228845209619962_o.jpg?_nc_cat=0&_nc_eui2=v1%3AAeEhIPUf7C4U3Ddl1U9aa8bhIXnm7ACoHp6_0wAjDI8G3Y2WF-iW-zK9eQi8gnPotzqNmv44zL53KXEp-bD2zZtSxXrcD40QeZQqCxH4NEAXBQ&oh=abf908c57635184d8acec348600bbf09&oe=5B52CB3B', preview_image_url='https://scontent.ftpe2-2.fna.fbcdn.net/v/t31.0-8/30420598_1772746002786979_2578228845209619962_o.jpg?_nc_cat=0&_nc_eui2=v1%3AAeEhIPUf7C4U3Ddl1U9aa8bhIXnm7ACoHp6_0wAjDI8G3Y2WF-iW-zK9eQi8gnPotzqNmv44zL53KXEp-bD2zZtSxXrcD40QeZQqCxH4NEAXBQ&oh=abf908c57635184d8acec348600bbf09&oe=5B52CB3B'),
     ...
     TextSendMessage(text='雖然第一次做大型專題,難免有困難,但我發現要與組員有效溝通,不是靠口頭表述,而是藉著圖表整理的實驗結果,更有說服力也能轉達想要表達的意思,並透過 GitHub 管理程式碼,可以更好的掌握進度與協力開發,避免時間拖延。。'),
     TextSendMessage(text='專題競賽海報:'),
     TextSendMessage(text='https://drive.google.com/open?id=1ckI6pIbABZSvs8wmloe2cYNLg8kLM3Pv'),
     TextSendMessage(text='競賽得獎紀錄:'),
     ImageSendMessage(original_content_url='https://goo.gl/bwQi94', preview_image_url='https://goo.gl/bwQi94'),
     ImageSendMessage(original_content_url='https://goo.gl/fkW5mM', preview_image_url='https://goo.gl/fkW5mM'),
     ImageSendMessage(original_content_url='https://goo.gl/UPjXx1', preview_image_url='https://goo.gl/UPjXx1')
]
...
worksIntro2 = [
     ...
     TextSendMessage(text='競賽得獎紀錄:'),
     ImageSendMessage(original_content_url='https://goo.gl/ByL1hL', preview_image_url='https://goo.gl/ByL1hL'),
     ImageSendMessage(original_content_url='https://goo.gl/pyhyBW', preview_image_url='https://goo.gl/pyhyBW')
]
...
worksIntro3 = [
     ...
     ImageSendMessage(original_content_url='https://goo.gl/AZ4yf5', preview_image_url='https://goo.gl/AZ4yf5'),
